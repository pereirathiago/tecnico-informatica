...
public class FlappyBird extends ApplicationAdapter {
	...
	public void create () {
		...
		passaros[0]=new Texture("bola.png");
		passaros[1]=new Texture("bola.png");
		passaros[2]=new Texture("bola.png");
	...
	public void render () {
		...
		batch.end();
		passaroForma=new
				Circle(200+passaros[0].getWidth()/2,posicaoInicialVertical+passaros[0].getHeight()/
				2,passaros[0].getWidth()/2);
		...
		if(Intersector.overlaps(passaroForma,canoBaixoForma)||Intersector.overlaps(
				passaroForma,canoTopoForma)||posicaoInicialVertical<=0 ||posicaoInicialVertical>=
				alturaDispositivo){
			estadoJogo=2;
		}
