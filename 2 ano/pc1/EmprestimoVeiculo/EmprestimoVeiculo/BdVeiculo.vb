...
Public Class BdVeiculo
    ...
    Public Sub inserir(ByVal veiculo As Veiculo)
        ...
        Try
            ...
            cmd.CommandText = "insert into veiculo (id, placa, marca, modelo, ano, chassi) values (@id, @placa, @marca, @modelo, @ano, @chassi)"
    ...
    Public Function pesquisa(ByVal placa As String) As DataSet
        ...
        Return ds
    End Function
    Public Function emprestimos() As DataSet
        Dim ds As New DataSet
        Dim da As MySqlDataAdapter = New MySqlDataAdapter
        Dim cmd As MySqlCommand = New MySqlCommand
        Try
