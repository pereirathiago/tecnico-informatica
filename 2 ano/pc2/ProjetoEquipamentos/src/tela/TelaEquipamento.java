...
public class TelaEquipamento extends javax.swing.JFrame {
    ...
    private void telaToEquipamento() {
        equipamento.setCodigo(Integer.parseInt(tCodigo.getText()));
        equipamento.setNumpatrimonio(Integer.parseInt(tNumpatrimonio.getText()));
        equipamento.setDescricao(tDescricao.getText());
        equipamento.setFabricante(tFabricante.getText());
        equipamento.setNumserie(tNumserie.getText());
        equipamento.setLocalizacao(tLocalizacao.getText());
    }
    private void equipamentoToTela() {
        tCodigo.setText(Integer.toString(equipamento.getCodigo()));
        tNumpatrimonio.setText(Integer.toString(equipamento.getNumpatrimonio()));
        tDescricao.setText(equipamento.getDescricao());
        tFabricante.setText(equipamento.getFabricante());
        tNumserie.setText(equipamento.getNumserie());
        tLocalizacao.setText(equipamento.getLocalizacao());
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("N° de patrimonio");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(22, 22, 22)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tLocalizacao, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tDescricao, javax.swing.GroupLayout.PREFERRED_SIZE, 255, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tFabricante, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(tNumserie, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 134, Short.MAX_VALUE)
                                .addComponent(tNumpatrimonio, javax.swing.GroupLayout.Alignment.LEADING))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
    ...
    private void tNumpatrimonioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tNumpatrimonioActionPerformed

    }//GEN-LAST:event_tNumpatrimonioActionPerformed

    private void bSalvaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSalvaActionPerformed
        telaToEquipamento();
        bd.salva(equipamento);
        this.dispose();
